...
export class UiContainer extends Phaser.GameObjects.Container {
    ...
    lineBtnInit() { 
        ...
        linePanel.setPosition(gameConfig.scale.width/5.2, this.maxbetBtn.y);
        ...
        this.mBtn = this.createButton('mBtn', -90, 3, () => {
            this.bnuttonMusic("buttonpressed");
    ...
    balanceBtnInit() {
        ...
        balancePanel.setPosition(gameConfig.scale.width / 1.25, this.maxbetBtn.y);
...
/**
    ...
    maxBetInit() {
        ...
        this.maxbetBtn = this.createButton('maxBetBtn', gameConfig.scale.width / 2 - this.maxbetBtn.width / 2, gameConfig.scale.height - this.maxbetBtn.height - 5 , () => {
    ...
    autoSpinBtnInit(spinCallBack: () => void) {
        ...
        this.autoBetBtn = this.createButton(
            'autoSpin',
            gameConfig.scale.width / 2 + this.autoBetBtn.width / 2,
